    ...
    <>
      ...
      <div className="min-h-screen" style={{ fontFamily: 'Montserrat, sans-serif', background: 'linear-gradient(180deg, #eae6d8 0%, #f0ece0 30%, #f8f6f0 100%)' }}>
        ...
        <nav className="px-5 md:px-10 py-4 md:py-5 flex justify-between items-center sticky top-0 z-50 border-b border-[#ddd8c4]" style={{ background: 'rgba(248, 246, 240, 0.95)', backdropFilter: 'blur(12px)' }}>
          <p className="text-[#1a1a1a] font-black text-base md:text-xl tracking-tight">Fakturagenerator</p>
          <div className="flex gap-3 md:gap-6 items-center">
            {anvandare ? (
              <>
                <a href="/mina-fakturor" className="text-[#444] hover:text-[#1a2d6e] text-sm transition-colors font-medium hidden md:block">Mina fakturor</a>
                <p className="text-xs text-[#999] hidden md:block">{anvandare.email}</p>
                <button
                  onClick={async () => { await supabase.auth.signOut(); setAnvandare(null) }}
                  className="text-[#444] hover:text-[#1a2d6e] text-sm transition-colors font-medium"
                >
                  Logga ut
                </button>
              </>
              ...
              <>
                <a href="/login" className="text-[#444] hover:text-[#1a2d6e] text-sm transition-colors font-medium hidden md:block">Logga in</a>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10 pt-12 md:pt-16 pb-8 overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-8">
            ...
            <p className="text-xs text-[#bbb] md:max-w-xs md:text-right leading-relaxed font-medium">
              Gratis att använda · Inget kreditkort krävs · Ingen bindningstid
            </p>
          </div>
        </div>
        ...
        <div className="border-y border-[#ddd8c4] py-4 md:py-5 my-6 md:my-8 overflow-hidden">
          <p className="text-xs text-[#bbb] uppercase tracking-[0.2em] md:tracking-[0.3em] text-center font-medium px-4">
            Förhandsgranskning &nbsp;·&nbsp; PDF-export &nbsp;·&nbsp; F-skatt &nbsp;·&nbsp; Moms &nbsp;·&nbsp; Bankgiro &nbsp;·&nbsp; Fakturahistorik &nbsp;·&nbsp; GDPR
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-16 md:py-20">
          <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-12 md:mb-16 gap-4">
            ...
            <p className="text-sm text-[#999] md:max-w-xs leading-relaxed md:pt-2 font-medium">Vi har byggt ett enkelt och kraftfullt verktyg anpassat för svenska företagare och frilansare.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-16 gap-y-10 md:gap-y-14">
            {[
              ...
              { nr: '05', titel: 'Fakturahistorik', text: 'Skapa ett konto och spara alla fakturor på ett ställe.' },
              { nr: '06', titel: 'Säker lagring', text: 'All data lagras krypterat på servrar inom EU, enligt GDPR.' },
            ].map((f) => (
        ...
        <div className="bg-[#1a2d6e] mx-4 md:mx-10 mb-12 md:mb-16 rounded-3xl px-8 md:px-16 py-14 md:py-20 max-w-6xl lg:mx-auto">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-8">
            ...
            <div className="md:text-right">
              <p className="text-[#7a8abe] mb-6 md:mb-8 text-sm leading-relaxed md:max-w-xs font-medium">Gratis att använda. Inget kreditkort krävs.</p>
